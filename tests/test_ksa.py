...
def test_makegraphs_label():
    p = makegraphs(FIXTURE1, "tempfilename", option=6, label="ridiculouslabel", opts={"suppress": True} )
...
def test_makegraphs_list_5():
    p = makegraphs([FIXTURE1, FIXTURE2], ["FIXTURE1", "SRR000331"], option=5, suppress=True)

def test_show_pretty_graphs():
    p = show_pretty_graphs([FIXTURE1, FIXTURE2], ["FIXTURE1", "SRR000331"], xlabel="X axis title", ylabel="Y axis title", name="Graph title here")
